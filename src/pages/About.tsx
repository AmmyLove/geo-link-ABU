...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        {/* Hero Section */}
        <section className="relative bg-gradient-to-br from-primary via-primary/90 to-primary/80 text-primary-foreground py-24 px-4 overflow-hidden">
          <div className="absolute inset-0 bg-primary/5 backdrop-blur-3xl"></div>
          <div className="container mx-auto text-center relative z-10">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 animate-fade-in-up">
              About Our Department
            </h1>
            <p className="text-xl md:text-2xl text-primary-foreground/90 max-w-4xl mx-auto leading-relaxed animate-fade-in-up">
          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <article className="space-y-6">
                <h2 className="text-4xl font-bold text-foreground mb-8">Our Heritage</h2>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center p-6 bg-card rounded-xl border border-border shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="text-muted-foreground font-medium">Alumni Worldwide</div>
                  </div>
                  <div className="text-center p-6 bg-card rounded-xl border border-border shadow-sm hover:shadow-md transition-shadow">
                    <Award className="text-primary mx-auto mb-3" size={40} />
                    <div className="text-3xl font-bold text-primary mb-1">100+</div>
                    <div className="text-muted-foreground font-medium">Research Publications</div>
                  </div>
                </div>
              </article>
        ...
        <section className="py-20 px-4 bg-muted/30">
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <article className="bg-card rounded-2xl p-8 shadow-lg border border-border">
                <header className="flex items-center mb-8">
                  <div className="p-3 bg-primary/10 rounded-xl mr-4">
                    <Target className="text-primary" size={32} />
                  </div>
                  <h3 className="text-3xl font-bold text-card-foreground">Our Mission</h3>
                </header>
        ...
        <section className="py-20 px-4 bg-background">
          <div className="container mx-auto">
            <header className="text-center mb-16">
              <h2 className="text-4xl font-bold text-foreground mb-4">Our Journey Through Time</h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
              {faculty.map((member, index) => (
                <article key={index} className="bg-card rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-border">
            ...
            <div className="text-center">
              <a 
                href="/lecturers" 
                className="inline-flex items-center px-8 py-4 bg-primary text-primary-foreground rounded-xl hover:bg-primary/90 transition-all duration-200 shadow-lg hover:shadow-xl font-semibold"
              >
